...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <form action=<%=request.getAttribute("basePath")%>insertInfo class="form-horizontal" role="form" method="post">
                <div class="form-group">
                    <label for="name" class="col-sm-2 control-label">秒杀物品名称</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" id="name" placeholder="请输入秒杀名称">
                    </div>
                </div>
                <div class="form-group">
                    <label for="number" class="col-sm-2 control-label">秒杀物品数量</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="number" id="number" placeholder="请输入秒杀物品的数量">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-append form_datetime date col-sm-10" id="datetimepicker">
                        <input  type="text" name="startTime" class="form-control" placeholder="请输入秒杀开启时间">
                ...
                <div class="form-group">
                    <label for="datetimepicker"  class="col-sm-2 control-label">秒杀开启时间</label>
                    <div class="input-append form_datetime date col-sm-10" id="datetimepicker">
                        <input  type="text" name="endTime" class="form-control" placeholder="请输入秒杀结束时间">
                        <span class="add-on"><i class="icon-th"></i></span>
                    </div>
                    <%--<div class="col_sm_2">
                        <img src="/resources/img/calendar.png" width="25px" height="25px">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <button type="submit" class="btn btn-default form-control">新增</button>
                    </div >
                    <div class="col-sm-2">
