...
import org.yumin.zengDaWebUI.config.Config;
...
public class TestReport implements IReporter{
	...
	private void outputResult(List<ITestResult> fullResults, String path){
		...
		try {
			...
			sb.append("<div id=\"logo\"><img src=\"yuminlogo.png\"></img></div>\n");//TODO
			...
			sb.append("<script type=\"text/javascript\">\n"
					...
					+ "</script>\n");
			//--所有测试结果展示--start
			sb.append("<table id=\"total\" border=\"1\" >\n");
			...
			sb.append("</div>\n"
					...
					+ "<div id=\"footer\" >技术支持：Copyright © 2014.Inc</div>");
			sb.append("</body>\n</html>\n");
			...
			sb2.append("<div id=\"logo\"><img src=\"\"></img></div>\n");//TODO
          ...
          /* sb2.append("</table>\n");*/
			...
			sb2.append("</table>\n</div>\n");
			sb2.append("</div>\n"
					+ "<div id=\"footer\" style=\"font-size:14px\" >技术支持：Copyright © 2017 YuMin科技.com</div>");
			sb2.append("</body>\n</html>\n");
			System.out.println("收件人地址："+Recipients);
