...
public class PageObjectAutoCode {
	...
	static  String path="src/main/java/org/yumin/zengDaWebUI/pageObjectConfig/UILibrary.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("import org.yumin.zengDaWebUI.utils.Locator;\n");
			...
			sb.append("private String path=\"src/main/java/org/yumin/zengDaWebUI/pageObjectConfig/UILibrary.xml\";\n");
